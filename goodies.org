...
** case-let
As of 2020-11-04 I think that small convenience due to slight code reduction does not compensate new symbol introduction,
so =case-let= remains unused for now.
