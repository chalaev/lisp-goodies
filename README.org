...
The Common Lisp part of the code is packaged into [[file:generated/cl-shalaev.tbz][cl-shalaev.tbz]]
...
** Emacs Lisp code
Either
1. copy-paste or load [[file:generated][generated/]]*.el into your projects or
2. unpack [[file:generated/el-shalaev.tbz][el-shalaev.tbz]] into your =~/.emacs.d/= directory:\\
   =tar xjfv el-shalaev.tbz --directory=$HOME/.emacs.d/=

   and include =~/.emacs.d/shalaev/= into emacs'es source directory list.

For usage example, see the [[https://github.com/chalaev/cloud][cloud (sync)]] project.
** Common Lisp code
Unpack [[file:generated/cl-shalaev.tbz][cl-shalaev.tbz]] into your [[https://www.quicklisp.org/beta/][Quicklisp]] directory:\\
=tar xjfv cl-shalaev.tbz --directory=$HOME/quicklisp/local-projects/=
...
6. [[file:Makefile][Makefile]] is used by =make= to test the code and to create package in =$HOME/quicklisp/local-projects/=;
   the resulting package files are archived in [[file:generated/cl-shalaev.tbz][cl-shalaev.tbz]],
...
8. [[file:helpers/][helpers/*]] assist compilation.
